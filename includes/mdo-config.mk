...
endef
define minify.awk
$(AWK) '{if ( $$0 ~ /^[[:blank:]]*#/ ) next;if ( $$0 ~ /\/.*#.*\// )gsub(/#[^\/]*$$/, "");else if ( $$0 ~ /".*#.*"/ );gsub(/#[^"]*$$/, "");else gsub(/#.*$$/, "");gsub(/^[[:blank:]]+/, "");gsub(/[\t]+/, "");gsub(/[[:blank:]]+$$/, "");if ( $$0 !~ /\,$$|\{$$|\?$$|\:$$|\|\|$$|\&\&$$|do$$|else$$|\($$|\\$$/ ) {if (! ( $$0 ~ /^if|^while|^for|^function/ && $$0 ~ /\)$$/ ) ) {if ( $$0 ~ /[^{};:]{1}$$/ ) $$0 = $$0 ";";}}gsub(/[\\]?$$/, " ");gsub(/[[:blank:]]+$$/, "");gsub(/[[:space:]]{2,}/, " ");if ( $$0 ~ /do$$|else$$/ ) $$0 = $$0 " ";printf "%s", $$0;}'
endef
