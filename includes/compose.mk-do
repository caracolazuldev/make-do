...
# If your command arguments conflict with this list, you will have to
# override it to exclude the keyword that appears in your command, and 
# this feature will not be available for that docker-compose command.
SUB_CMD_ABLE ?= up down run exec logs
